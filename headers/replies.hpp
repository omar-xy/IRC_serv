...
#define RPL_CHANNELMODEIS(channel, hostname, mode, modeArgs) ":" + hostname + " MODE " + channel + " " + mode + " " + modeArgs "\r\n"
...
#define PRIVMSG_FORMATCH(senderNick, senderUsername, senderHostname, receiver, message) ":" + senderNick + "!~" + senderUsername + "@" + senderHostname + " PRIVMSG " + receiver + " :" + message + "\r\n"
